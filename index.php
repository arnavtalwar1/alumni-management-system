<?php
session_start();
// Prevent browser caching for security (back-button logout issue)
...
<body id="page-top" onpageshow="if (event.persisted) window.location.reload()">
  <!-- Navigation-->
  ...
  <footer class=" py-5">
    ...
    <br>
    <div class="container">
      <div class="small text-center text-muted">Copyright © 2025 - <?php echo $_SESSION['system']['name'] ?> | <a
          href="" target="_blank">Arnav Talwar & Aniket Sharma</a></div>
    </div>
  </footer>
  ...
  <!-- Login Options Modal -->
  <div class="modal fade" id="loginOptionsModal" tabindex="-1" aria-labelledby="loginOptionsLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content p-3">
        <div class="modal-header">
          <h5 class="modal-title" id="loginOptionsLabel">Choose Login Type</h5>
          <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body text-center">
          <a href="admin/login.php" class="btn btn-danger mb-2 w-100">Login to Admin Portal</a>
          <button class="btn btn-success w-100" onclick="uni_modal('Login','login.php')">Login as
